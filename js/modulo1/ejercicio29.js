/**
 * La función getShippingCost(country) debe comprobar si el artículo puede ser entregado en 
 * el país del usuario (parámetro country) y devolver un mensaje sobre el resultado almacenado 
 * en la variable message. Asegúrese de usar la instrucción "switch".

El formato de la cadena de retorno es "Shipping to <country> will cost <price> credits", 
donde <country> y <price> deben sustituirse por los valores adecuados.
...
En la lista se puede ver que la entrega no está disponible en todas partes. 
Si el país especificado no está en la lista, la función debería devolver la secuencia "Sorry, 

/**
 * La función getDiscount(totalSpent) define un valor de descuento dependiendo de la cantidad 
 * total de dinero gastado (parámetro totalSpent) en la tienda durante todo el tiempo 
 * (programa de afiliados). El descuento se escribe en la variable discount y se devuelve 
 * desde la función como resultado de su trabajo.
...
Los valores de descuento de cada nivel se almacenan en constantes del mismo nombre BASE_DISCOUNT,
 BRONZE_DISCOUNT, SILVER_DISCOUNT y GOLD_DISCOUNT.

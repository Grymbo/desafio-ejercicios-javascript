/**
 * La función checkPassword(password) compara la contraseña que se le proporciona 
 * (parámetro password) con la contraseña del administrador guardada (constante ADMIN_PASSWORD) y
 *  devuelve una secuencia con un mensaje sobre el resultado

Usando un operador ternario, completa la función para:

Si los valores de passwordyADMIN_PASSWORDson iguales, asigne la variablemessagea la 
secuencia"Access is allowed"`.

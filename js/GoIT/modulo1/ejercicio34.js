/**
 * La función normalizeInput(input) toma una secuencia (parámetro de entrada) y devuelve la
 *  misma secuencia, pero en minúsculas. Asigne la variable normalizedInput para crear una
 *  secuencia en minúsculas a partir del parámetro input.
...
const normalizedInput = (input) => {
    const minusculas = input.toLowerCase();
    return minusculas;
}

/**
 * La función isNumberNotInRange(start, end, number) comprueba si un número está en un intervalo. 
 * Es decir, el número debe ser menor o igual que start y mayor o igual que final. 
 * El resultado de la expresión de verificación es true o false.
...
Asigna a la variable isNotInRange una expresión para invertir el valor de la variable isInRange 
usando el operador !.
 ...
 */
const isNumberNotInRange = (start, end, number) => {

/**
 * Modificar la solución del problema del «stock de artíclulos» sustituyendo la instrucción if...else 
...
const checkStorage = (available, ordered) => {
    return available >= ordered ? "The order is accepted, our manager will contact you" : "Not enough goods in stock!";
}
